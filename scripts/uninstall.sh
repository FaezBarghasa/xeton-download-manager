...
delete_app() {
    ...
    remove_if_exists "$HOME/.local/share/applications/com.xetondownloadmanager.desktop"
    ...
    remove_if_exists "$HOME/.config/autostart/com.xetondownloadmanager.desktop"
